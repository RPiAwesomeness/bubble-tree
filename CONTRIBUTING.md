# Contributing to Bubble Tree

Welcome! Thank you in advance for your interest in contributing to Bubble Tree!

## The Basics

Bubble Tree welcomes contributions in the form of pull requests.

For small changes (e.g., bug fixes), feel free to submit a PR.

For larger changes (e.g., new functionality, new configuration options), consider creating an [**issue**](https://github.com/RPiAwesomeness/bubble-tree/issues) outlining your proposed change.

### Prerequisites

Bubble Tree is written in Go. You'll need to install the [Go toolchain](https://go.dev/doc/install) for development.

### Development

The easiest way to get set up with everything you need is to work in a Dev Container or in GitHub Codespaces. The Bubble Tree repo includes a [Dev Container](https://containers.dev/) configuration. By opening the repo in a Dev Container, you will have all tools/dependencies installed for you for easy contributing.
...
## Adding yourself to the contributors listed in the Bubble Tree README
